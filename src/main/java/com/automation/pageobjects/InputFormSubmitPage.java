...
public class InputFormSubmitPage extends TestBase{
	...
	public void inputFormLaunch() 
	{
		...
		test.log(Status.INFO, "Input Form Submit launched");
	}
	...
	public AjaxFormSubmitPage enterInputFormDetails() throws Exception
	{
		...
		test.log(Status.PASS, "InputFormSubmit Button is clicked withOut DataProvider");
	...
	public AjaxFormSubmitPage enterInputFormDetails(	String string1,
										String string2,
										String string3,
										String string4,
										String string5,
										...
										String string9) throws Exception
	{
		...
		test.log(Status.PASS, "InputFormSubmit Button is clicked Using DataProvider");
		return PageFactory.initElements(driver, AjaxFormSubmitPage.class);
	...
	public void inputFormSubmitInValidValidations()
	{
		...
		test.log(Status.INFO, "InputFormSubmit Button Error Validation is Completed");
