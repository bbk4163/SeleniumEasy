...
public class selenium_Easy_JQuery_DropDown extends TestBase{
	
		
	public static final Logger log=Logger.getLogger(selenium_Easy_JQuery_DropDown.class.getName());
	...
	MainClass.NavigateToJQuerySelectDropdown();
	...
	public void SearchAndSelectCountry(){
		...
		// ============== This is the test calling from InputForms.java =========//
		// ============== This is the test calling from InputForms.java =========//
		// ============== This is the test calling from InputForms.java =========//
		
		log.info("======= Start Verifying Country Selected =======");
		//InputForms(driver);
		//InputForms.searchnSelectCountry("hong");
		
		String a = driver.findElement(By.xpath(".//*[@id='select2-country-container']")).getText();
		System.out.println(a);
		boolean SelectedItem = a.equals("Hong Kong");
		if (SelectedItem = true){
			System.out.println("Selected Country is: "+a);
		}
		else{
			System.out.println("Selected Country is not: "+a);
		}
		
		log.info("======= Finished Verifying Country Selected =======");
	...
	public void MultiSelectStates() throws Exception{
		...
		log.info("======= Start Multi Select State TestCase Execution =======");
		...
		log.info("======= Multi Select State TestCase Execution =======");
	...
	public void DropDownWithTerritoryEnabled() throws InterruptedException{
		MainClass.NavigateToJQuerySelectDropdown();
		log.info("======= Start Execution of DropDownWithDisabledValues test case =======");
		System.out.println("******************************");
		...
		log.info("======= Finished Execution of DropDownWithDisabledValues test case =======");
	}
	...
	public void VerifyDropdownWithCategoryRelatedOptions() throws InterruptedException{
		...
		log.info("****** Start Executing VerifyDropdownWithCategoryRelatedOptions *****");
		MainClass.NavigateToJQuerySelectDropdown();
		...
		log.info("****** Completed Executing VerifyDropdownWithCategoryRelatedOptions *****");
	}
